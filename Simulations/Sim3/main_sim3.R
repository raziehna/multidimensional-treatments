...
# augment = FALSE  # if weight = FALSE, augment won't matter anymore
# 
...
source("data_sim3.R")
source("analysis_sim3.R")
source("derivatives_sim3.R")
source("propensity_sim3.R")
source("regression_sim3.R")
