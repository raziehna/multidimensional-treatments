...
get_fA_fAC <- function(n, p, case, C, A, Y, dat, method,  samp_size){
 
 # Estimate the covariance matrix 
 Sigma = cov(dat)
 
 # p(A)
 # Keep in mind that p(A) can be anything but maybe it would be more efficient if mean A is said to colMeans(A)
